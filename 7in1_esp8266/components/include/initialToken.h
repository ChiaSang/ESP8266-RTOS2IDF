 ...
 *
 */
#define ONENET_PRODUCT_ID "MM7lNSfMRo" //产品ID
 ...
 *
 */
#define ONENET_PRODUCT_KEY "+mjxDIkX+dLcHNpkYXF32dz4z2GDZ/1ozpiS6grIVOY=" //产品KEY
 ...
 *
 */
#define ONENET_DEVICE_KEY "1ek1TYyQRXJ0jumapVA04Mu4BsVcpIVMJ2Ec5kiGrTo=" //设备KEY
